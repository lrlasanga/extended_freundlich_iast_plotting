...
if __name__ == "__main__":
    ...
    for CA in Ce_A:
        ...
        plt.plot(log_Ce_B, log_qe_B, linestyle='-', label=f'{args.A} = {CA} ppm')
    plt.xlabel('log(Ce)')
    plt.ylabel('log(qe)')
    plt.title(f'Plots of {args.B} adsorption against {args.A} adsorption')
    plt.grid(True)
    plt.legend()
    plt.show()
    ...
    for CB in Ce_B:
        ...
        plt.plot(log_Ce_A, log_qe_A, linestyle='-', label=f'{args.B} = {CB} ppm')
    plt.xlabel('log(Ce)')
    plt.ylabel('log(qe)')
    plt.title(f'Plots of {args.A} adsorption against {args.B} adsorption')
    plt.grid(True)
    plt.legend()
    plt.show()
